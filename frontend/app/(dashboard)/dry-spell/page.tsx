        ...
        <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
          <div className="space-y-1">
            ...
            <p className="max-w-3xl text-[14px] leading-6 text-[#6b7a8d]">
              Displays grid-level probability of prolonged dry periods after rainfall onset, helping identify areas where crops may face moisture stress during the rainy season.
            </p>
          </div>
          {liveStatus === "live" && (
